...
>>>>>>> d2599e6edf737231250a674deef9bf574528f67e
...
| `reto1_temperatura.ipynb` | Clasificación térmica y riesgo | Angie Acuña |
| `reto2_ph.ipynb` | Evaluación de pH y alerta química | Juan Herrera  |
| `reto3_oxigeno.ipynb` | Análisis biológico por oxígeno | Sara y Daniel |
| `reto4_integracion.ipynb` | Diagnóstico final integrando variables | Gabriela  |
